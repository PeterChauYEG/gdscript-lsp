...
# (clippy), or comment on the existing open one for this PR + job instead of
# creating a duplicate.
#
# Adapted from laboratory-one-web's scripts/file-linear-ticket.sh (see the
# "Web CI" Linear doc) for this Rust repo — same dedup-by-exact-title
# behavior, swapped the `web` label for `rust`.
#
...
# LAB team label IDs, from $HARNESS_DIR/configs/linear-labels.json —
